...
import 'package:sunmkit/src/command_runner.dart';
...
void main() {
  group('SunmkitCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late SunmkitCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = SunmkitCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = SunmkitCommandRunner();
